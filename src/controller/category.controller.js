...
import { SendError, SendSuccess, SendCreate, SendError400 } from "../service/response.js";
    ...
    static async getAll(req, res) {
        try {
            ...
            connected.query(category, (err, result) => {
                if (err) return SendError(res, 404, EMessage.NotFound + " category", err);
                if (!result[0])
